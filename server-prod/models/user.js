...
var userSchema = new mongoose_1.Schema({
    ...
    likedItems: [
        { item: { type: mongoose_1.default.Types.ObjectId, ref: "Item", required: true } }
    ],
    follows: [
    ...
    notifications: [
        {
            ...
            user: { type: mongoose_1.default.Types.ObjectId, ref: "User", required: true },
            item: { type: mongoose_1.default.Types.ObjectId, ref: "Item" },
            userWhoGotFollow: { type: mongoose_1.default.Types.ObjectId, ref: "User" },
            isReaded: {
                type: Boolean,
                default: false
            }
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    user = this;
                    token = jsonwebtoken_1.default.sign({ _id: user._id.toString() }, process.env.SECRET_KEY);
...
userSchema.statics.findByCredenctials = function (email, password) { return __awaiter(void 0, void 0, void 0, function () {
    var user, isMatch;
    return __generator(this, function (_a) {
        switch (_a.label) {
